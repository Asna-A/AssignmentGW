...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, StateTableComponent, GoogleComponent, NumbersComponent, NestedListComponent, AlertMeComponent, LeapYearComponent, ShoppingListComponent,RouterLink,RouterLinkActive],
